...
public class Noppa implements Comparable<Noppa> {
    ...
    /**
     * <code>Randomia</code> käytetään luomaan satunnaisia kokonaislukuja
     * simuloitaessa nopan heittoa.
     */
    ...
    /**
     * Yatzy-pelissä heittojen välillä voidaan valita tietty määrä noppia, joita
     * ei heitetä. Tämä muuttuja kertoo onko kyseessä oleva noppa valittuna.
     */
    private boolean valittu;

    /**
     * Luo uuden Noppa-luokan ilmentymän, jonka silmäluku on 1 ja noppa ei ole
     * valittu.
     */
    public Noppa() {
        this(1);
    ...
    /**
     * Luo nopan, jonka silmäluvun käyttäjä antaa parametrina. Noppa ei ole
     * valittu.
     *
    ...
    /**
     * Valitsee nopan. Eli oliomuuttujan
     * <code>valittu</code> arvoksi tulee
     * <code>true</code>.
     */
    public void valitse() {
        this.valittu = true;
    ...
    /**
     * Metodi mahdollistaa
     * <code>Noppa</code>-luokan ilmentymien vertailun noppien silmälukujen
     * perusteella.
     *
